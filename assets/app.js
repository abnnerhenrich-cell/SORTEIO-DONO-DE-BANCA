...
function bindEvents(){
  $('btnInicio')?.addEventListener('click', () => showPage('home'));
  $('btnGanhadores')?.addEventListener('click', () => showPage('ganhadores'));
  $('btnAdmin')?.addEventListener('click', openLogin);
  $('btnVerGanhadores')?.addEventListener('click', () => showPage('ganhadores'));
  $('btnParticiparAgora')?.addEventListener('click', () => $('sorteios')?.scrollIntoView({behavior:'smooth'}));
  $('btnCadastro')?.addEventListener('click', abrirCadastro);
  $('btnEntrarAdmin')?.addEventListener('click', loginAdmin);
  $('btnConfirmarParticipacao')?.addEventListener('click', salvarParticipacao);
  $('btnSairAdmin')?.addEventListener('click', logoutAdmin);
